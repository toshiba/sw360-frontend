...
export function addAdditionalRoles(roleSelected, mailInput) {
    cy.get(addEditSelectors.additionalRoles.btnAddRow).click()
    cy.get(addEditSelectors.additionalRoles.role).last().select(roleSelected)
    cy.get(addEditSelectors.additionalRoles.mail).last().should('exist')
        .type(mailInput)
}
...
export function fillDataSummaryTab(testData, isUpdate) {
    ...
    for (let i = 0; i < nStep; i++) {
        ...
        switch (keyFieldName) {
            ...
            //     break
            // case 'external_URL':
            //     cy.addKeyValueRow(addEditSelectors.externalURLs, fieldValue)
            //     break
            ...
            //     if (isUpdate == true)
            //         cy.get(addEditSelectors.ownerAccountingUnit).clearAndType(fieldValue)
            //     else
            //         cy.get(addEditSelectors.ownerAccountingUnit).type(fieldValue)
            //     break
            // case 'owner_billing_group':
            //     if (isUpdate == true)
            //         cy.get(addEditSelectors.ownerBillingGroup).clearAndType(fieldValue)
            //     else
            //         cy.get(addEditSelectors.ownerBillingGroup).type(fieldValue)
            //     break
            // case 'owner_country':
            //     cy.get(addEditSelectors.ownerCountry)
            ...
            //     break
            // case 'external_ids':
            //     cy.addKeyValueRow(addEditSelectors.externalIds, fieldValue)
            //     break
            // case 'external_data':
            //     cy.addKeyValueRow(addEditSelectors.additionalData, fieldValue)
            //     break
            default:
                break
        }
    ...
    for (let i = 0; i < nStep; i++) {
        ...
        switch (keyFieldName) {
            ...
            case 'deadline_for_pre_evaluation':
                cy.get(addEditSelectors.dtDeadline_for_pre_evaluation).click()
                    .type(fieldValue)
                break
...
// function verifySummaryTab(expectedOutput) {
...
//                     break
//                 // case 'version':
//                 //     cy.get(viewSelectors.version).should('contain', fieldValue)
//                 //     break
//                 // case 'visibility':
//                 //     cy.get(viewSelectors.visibility).should('contain', fieldValue.name)
//                 //     break
//                 // case 'project_type':
//                 //     cy.get(viewSelectors.projectType).should('contain', fieldValue.name)
//                 //     break
//                 // case 'tag':
//                 //     cy.get(viewSelectors.tag).should('contain', fieldValue)
//                 //     break
//                 // case 'description':
//                 //     cy.get(viewSelectors.description).should('contain', fieldValue)
//                 //     break
//                 // case 'domain':
//                 //     cy.get(viewSelectors.domain).should('contain', fieldValue)
//                 //     break
//                 // case 'external_URL':
//                 //     cy.get(viewSelectors.externalURLs).should('contain', fieldValue.key)
//                 //     cy.get(viewSelectors.externalURLs).should('contain', fieldValue.value)
//                 //     break
//                 // case 'project_manager':
//                 //     cy.get(viewSelectors.projectManager).should('not.be.empty')
//                 //     break
//                 // case 'project_owner':
//                 //     cy.get(viewSelectors.projectOwner).should('not.be.empty')
//                 //     break
//                 // case 'owner_accounting_unit':
...
//                 // case 'owner_billing_group':
//                 //     if (isUpdate == true)
//                 //         cy.get(viewSelectors.ownerBillingGroup).clearAndType(fieldValue)
//                 //     else
//                 //         cy.get(viewSelectors.ownerBillingGroup).type(fieldValue)
//                 //     break
//                 // case 'owner_country':
//                 //     cy.get(viewSelectors.ownerCountry)
//                 //     .select(fieldValue.name)
//                 //     break
//                 // case 'lead_architect':
//                 //     cy.selectOneUser(viewSelectors.dialogLeadArchitect, fieldValue.user_no)
//                 //     break
//                 // case 'moderators':
//                 //     cy.selectMultiUsers(viewSelectors.dialogModerators, fieldValue.num_user)
//                 //     break
//                 // case 'contributors':
//                 //     cy.selectMultiUsers(viewSelectors.dialogContributors, fieldValue.num_user)
//                 //     break
//                 // case 'securityResponsibles':
//                 //     cy.selectMultiUsers(viewSelectors.dialogSecurityResponsibles, fieldValue.num_user)
//                 //     break
//                 // case 'additional_roles':
//                 //     addAdditionalRoles (fieldValue.value, fieldValue.mail)
//                 //     break
//                 // case 'external_ids':
//                 //     cy.addKeyValueRow(viewSelectors.externalIds, fieldValue)
//                 //     break
//                 // case 'external_data':
//                 //     cy.addKeyValueRow(viewSelectors.additionalData, fieldValue)
//                 //     break
//                 default:
//                     break
//         }
