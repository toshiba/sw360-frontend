...
Cypress.Commands.add('selectOrAddVendor', (dialogButtonsSelector, vendorInputData) => {
  cy.get(dialogButtonsSelector.searchBtn)
    .contains('Search')
    .click()
  cy.get('.gridjs .gridjs-tbody').should('be.visible')
  cy.selectItemsFromTable(dialogButtonsSelector.selectUser, false, vendorInputData.user_no)
