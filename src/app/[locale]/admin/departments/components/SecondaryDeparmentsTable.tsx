...
import SecondaryDeparments from './SecondaryDepartments'

const SecondaryDeparmentsTable = (): JSX.Element => {
    const t = useTranslations('default')
    const [tableData, setTableData] = useState<Array<Array<string | string[]>> | undefined>(undefined)
...
export default SecondaryDeparmentsTable