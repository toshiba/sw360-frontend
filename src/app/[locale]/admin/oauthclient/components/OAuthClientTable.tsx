                ...
                <thead>
                    <tr>
                        <th className='text-center align-middle'>
                            ...
                            >
                                {allRowsExpanded ? (
                                    <FaCaretDown className='text-white' size={15} />
                                ) : (
                                    <FaCaretRight className='text-white' size={15} />
                                )}
                            </button>
                        </th>
                        <th style={{ width: '30%' }} onClick={() => handleSort('description')} className='text-start align-middle'>
                        ...
                        <th style={{ width: '25%' }} onClick={() => handleSort('clientId')} className='text-start align-middle'>
                            <span className='d-flex justify-content-between align-items-center w-100'>
                        ...
                        <th style={{ width: '15%' }} onClick={() => handleSort('authorities')} className='text-start align-middle'>
                            <span className='d-flex justify-content-between align-items-center w-100'>
                        ...
                        <th style={{ width: '15%' }} onClick={() => handleSort('scope')} className='text-start align-middle'>
                            <span className='d-flex justify-content-between align-items-center w-100'>
                        ...
                        <th style={{ width: '10%' }} className='align-middle'>{t('Actions')}</th>
                    </tr>
                </thead>
                <tbody>
                                ...
                                <td className='text-center align-middle'>
                                    ...
                                    >
                                        {expandedRows[row.clientId] ? (
                                            <FaCaretDown className='text-muted' size={15} />
                                        ) : (
                                            <FaCaretRight className='text-muted' size={15} />
                                        )}
                                    </button>
                                </td>
