        ...
        <table className={`table label-value-table ${styles['summary-table']}`}>
            ...
            <tbody hidden={toggle}>
                ...
                <tr className='spdx-full'>
                    ...
                    <td>The Saxon package is a collection of tools for processing XML documents.</td>
                </tr>
                <tr className='spdx-full'>
                    <td>1.5 Comment</td>
                    ...
                    <td>
                        <div className='spdx-col-2 section' data-size='4'>
                            ...
                            <div className='spdx-flex-row'>
                                ...
                                <div className='spdx-col-3'>application/json</div>
                            </div>
                            <div className='spdx-flex-row'>
                    ...
                    <td>
                        <div className='spdx-col-2 section' data-size='4'>
                            ...
                            <div className='spdx-flex-row'>
                                ...
                                <div className='spdx-col-3 spdx-uppercase'>SPDXID-glibc</div>
                            </div>
                            <div className='spdx-flex-row'>
                    ...
                    <td>
                        <div className='spdx-col-2 spdx-flex-col'>
                            <div className='spdx-flex-row'>
                                ...
                                <div className='spdx-col-3'>MD5</div>
                            </div>
                            <div className='spdx-flex-row'>
                                <div className='spdx-col-1 spdx-key'>Comment</div>
                                <div className='spdx-col-3'>Comment</div>
                ...
                <tr>
                    ...
                    <td>
                        <div className='spdx-col-2 spdx-flex-col'>
                            <div className='spdx-flex-row'>
                                <div className='spdx-col-1 spdx-key'>Hash Value</div>
                                <div className='spdx-col-3'>d6a770ba38583ed4bb4525bd96e50461655d2759</div>
                            </div>
                            <div className='spdx-flex-row'>
