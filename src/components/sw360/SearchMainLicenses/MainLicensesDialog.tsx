...
import SelectTableLicenses from './SelectTableMainLicenses'
...
const LicensesDiaglog = ({ show, setShow, session, selectLicenses }: Props) => {
            ...
            <Modal.Body>
                <div className='modal-body'>
                    ...
                    <div className='row mt-3'>
                        <SelectTableLicenses licenseDatas={licenseDatas} setLicenses={getLicenses} fullnames={licenses} />
                    </div>
                </div>
            </Modal.Body>
...
export default LicensesDiaglog
